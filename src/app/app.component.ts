...
export class AppComponent {
  ...
  productsData=[
    ...
    },
    {
      ...
      text: "Булочка для бургера, котлета куриная, грудинка, яйцо, огурец маринованный, криспи лук, кетчуп, соуссырный, горчица, зелень",
      price: 9,
      basePrice: 9,
      grams: 320
    },
  ...
  confirmOrder () {
    if (this.form.valid) {
      alert("Спасибо за заказ! Мы коро свяжемся с вами.");
      this.form.reset();
    }
